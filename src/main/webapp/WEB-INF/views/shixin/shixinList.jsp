					...
					<div class="col-md-12">
						...
						<div class="widget wgreen">
							<div class="widget-head">
								<div class="pull-left">失信人信息爬取进度查询</div>
							...
							<div class="widget-content">
								<div class="padd">
									...
									<form id="queryForm" class="form-horizontal"
										action="${ctx}/shixin/list" method="post">
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												<select id="flag" name="search_EQ_flag" class="form-control">
													...
													<option value='0' <c:if test="${'0' eq param.search_EQ_flag}">selected</c:if> >爬取中</option>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="widget">
							<div class="widget-head">
								<div class="pull-left">失信人信息爬取进度列表</div>
								<div class="widget-icons pull-right">
									<a href="#" class="wminimize"><i class="icon-chevron-up"></i></a>
									<a href="#" class="wclose"><i class="icon-remove"></i></a>
								</div>
...
<script type="text/javascript">
	function doShowDetail(merName) {
		window.location.href='${ctx}/shixin/queryInfo?merName='+merName;
// 		$.ajax({
// 			cache : true,
// 			type : 'POST',
// 			url : '${ctx}/shixin/queryInfo',
...
// 		});
	...
	function doShowLog(merName) {
		window.location.href='${ctx}/shixin/queryLog?merName='+merName;
// 		$.ajax({
// 			cache : true,
// 			type : 'POST',
// 			url : '${ctx}/shixin/queryLog',
// 			data: 'merName=' + merName,
// 			success : function(data) {
// 				$("body").html(data);
// 			},
