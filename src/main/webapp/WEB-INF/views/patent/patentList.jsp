					...
					<div class="col-md-12">
						<div class="widget wgreen">
							<div class="widget-head">
								<div class="pull-left">专利爬取进度查询</div>
							...
							<div class="widget-content">
								<div class="padd">
									...
									<form id="queryForm" class="form-horizontal"
										action="${ctx}/patent/list" method="post">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="widget">
							<div class="widget-head">
								<div class="pull-left">专利爬取进度列表</div>
								<div class="widget-icons pull-right">
									<a href="#" class="wminimize"><i class="icon-chevron-up"></i></a>
									<a href="#" class="wclose"><i class="icon-remove"></i></a>
								</div>
...
<script type="text/javascript">
	function doShowDetail(merName) {
		window.location.href='${ctx}/patent/queryInfo?merName='+merName;
// 		$.ajax({
// 			cache : true,
// 			type : 'POST',
// 			url : '${ctx}/patent/queryInfo',
...
// 		});
	...
	function doShowLog(merName) {
		window.location.href='${ctx}/patent/queryLog?merName='+merName;
// 		$.ajax({
// 			cache : true,
// 			type : 'POST',
// 			url : '${ctx}/patent/queryLog',
// 			data: 'merName=' + merName,
// 			success : function(data) {
// 				$("body").html(data);
// 			},
