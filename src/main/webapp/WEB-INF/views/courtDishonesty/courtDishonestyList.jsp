...
<div class="content">
	...
	<div class="mainbar">
		...
		<div class="page-head">
			<h2 class="pull-left">
				<i class="icon-table"></i> 法院黑名单信息管理
			</h2>
					...
					<div class="col-md-12">
						...
						<div class="widget wgreen">
							<div class="widget-head">
								<div class="pull-left">法院黑名单信息爬取进度查询</div>
							...
							<div class="widget-content">
								<div class="padd">
									...
									<form id="queryForm" class="form-horizontal"
										action="${ctx}/courtDishonesty/list" method="post">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="widget">
							<div class="widget-head">
								<div class="pull-left">法院黑名单信息爬取进度列表</div>
								<div class="widget-icons pull-right">
									<a href="#" class="wminimize"><i class="icon-chevron-up"></i></a>
									<a href="#" class="wclose"><i class="icon-remove"></i></a>
								</div>
...
<script type="text/javascript">
	function doShowDetail(name) {
		window.location.href='${ctx}/courtDishonesty/queryInfo?name='+name;
// 		$.ajax({
// 			cache : true,
// 			type : 'POST',
// 			url : '${ctx}/courtDishonesty/queryInfo',
// 			data: 'name=' + name,
