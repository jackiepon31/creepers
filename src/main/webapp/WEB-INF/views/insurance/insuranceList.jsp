					...
					<div class="col-md-12">
						...
						<div class="widget wgreen">
							<div class="widget-head">
								<div class="pull-left">社保信息爬取进度查询</div>
							...
							<div class="widget-content">
								<div class="padd">
									...
									<form id="queryForm" class="form-horizontal"
										action="${ctx}/insurance/list" method="post">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="widget">
							<div class="widget-head">
								<div class="pull-left">社保信息爬取进度列表</div>
								<div class="widget-icons pull-right">
									<a href="#" class="wminimize"><i class="icon-chevron-up"></i></a>
									<a href="#" class="wclose"><i class="icon-remove"></i></a>
								</div>
													...
													<c:if test="${result.flag == '1'}">
														...
														<td>
															<button class="btn btn-xs btn-success" title="详情"
																onclick="javascript:doShowDetail('${result.userCode}')">
																<i class="icon-list"></i>
															</button>
															<button class="btn btn-xs btn-primary" title="重新爬取"
																onclick="doRecycle(this,'${result.userCode}')">
													...
													<c:if test="${result.flag == '2'}">
														...
														<td>
															<button class="btn btn-xs btn-warning" title="错误日志"
																onclick="javascript:doShowLog('${result.userCode}')">
																<i class="icon-list"></i>
															</button>
															<button class="btn btn-xs btn-primary" title="重新爬取"
																onclick="doRecycle(this,'${result.userCode}')">
...
<script type="text/javascript">
	function doShowDetail(userCode) {
		window.location.href='${ctx}/insurance/queryInfo?userCode='+userCode;
// 		$.ajax({
// 			cache : true,
// 			type : 'POST',
// 			url : '${ctx}/insurance/queryInfo',
...
// 		});
	...
	function doShowLog(userCode) {
		window.location.href='${ctx}/insurance/queryLog?userCode='+userCode;
// 		$.ajax({
// 			cache : true,
// 			type : 'POST',
// 			url : '${ctx}/insurance/queryLog',
