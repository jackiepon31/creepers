					...
					<div class="col-md-12">
						<div class="widget wgreen">
							<div class="widget-head">
								<div class="pull-left">法院判决书爬取进度查询</div>
							...
							<div class="widget-content">
								<div class="padd">
									...
									<form id="queryForm" class="form-horizontal"
										action="${ctx}/judgement/list" method="post">
...
<script type="text/javascript">
	function doShowDetail(merName) {
		window.location.href='${ctx}/judgement/queryInfo?merName='+merName;
// 		$.ajax({
// 			cache : true,
// 			type : 'POST',
// 			url : '${ctx}/judgement/queryInfo',
...
// 		});
	...
	function doShowLog(merName) {
		window.location.href='${ctx}/judgement/queryLog?merName='+merName;
// 		$.ajax({
// 			cache : true,
// 			type : 'POST',
// 			url : '${ctx}/judgement/queryLog',
// 			data: 'merName=' + merName,
// 			success : function(data) {
// 				$("body").html(data);
// 			},
