					...
					<div class="col-md-12">
						...
						<div class="widget wgreen">
							<div class="widget-head">
								<div class="pull-left">导游证信息爬取进度查询</div>
							...
							<div class="widget-content">
								<div class="padd">
									...
									<form id="queryForm" class="form-horizontal"
										action="${ctx}/touristGuide/list" method="post">
										<div class="form-group">
											<div class="col-md-12"></div>
										</div>
										<div class="form-group">
											<label class="col-md-2 control-label">导游证号</label>
											<div class="col-md-3">
												<input class="form-control" type="text" id="guideNo"
													name="guideNo" value="${guideNo}">
											</div>

											<label class="col-md-2 control-label">导游卡号</label>
											<div class="col-md-3">
											...
											<div class="col-md-3">
												<input class="form-control" type="text" id="usr"
													name="LIKE_certNo" value="${LIKE_certNo}">
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-2 control-label">开始日期</label>
											<div class="col-md-3">
												<input type="text" id="startDt" name="GT_updatedDt"
													class="form-control form_date" value="${GT_updatedDt}"
													data-date-format="yyyy-mm-dd">
											</div>
											<label class="col-md-2 control-label">结束日期</label>
											<div class="col-md-3">
												<input type="text" id="endDt" name="LT_updatedDt"
													class="form-control form_date" value="${LT_updatedDt}"
													data-date-format="yyyy-mm-dd">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-3">
												<select id="flag" name="flag" class="form-control">
													...
													<option value='0'
														<c:if test="${'0' eq flag}">selected</c:if>>默认</option>
													<option value='1'
														<c:if test="${'1' eq flag}">selected</c:if>>成功</option>
													<option value='2'
														<c:if test="${'2' eq flag}">selected</c:if>>失败</option>
												</select>
											</div>
											<div class="col-md-3">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="widget">
							<div class="widget-head">
								<div class="pull-left">导游证信息爬取进度列表</div>
								<div class="widget-icons pull-right">
									<a href="#" class="wminimize"><i class="icon-chevron-up"></i></a>
									<a href="#" class="wclose"><i class="icon-remove"></i></a>
								</div>
													...
													<c:if test="${result.flag == '0'}">
														...
														<td>
															<button class="btn btn-xs btn-primary" title="重新爬取"
																onclick="doRecycle(this,'${result.guideNo}','${result.cardNo}')">
																<i class="icon-play"></i>
															</button>
														</td>
													</c:if>
													<c:if test="${result.flag == '1'}">
														...
														<td>
															<button class="btn btn-xs btn-success" title="详情"
																onclick="doShowDetail('${result.guideNo}','${result.cardNo}')">
																<i class="icon-list"></i>
															</button>
															<button class="btn btn-xs btn-primary" title="重新爬取"
																onclick="doRecycle(this,'${result.guideNo}','${result.cardNo}')">
													...
													<c:if test="${result.flag == '2'}">
														...
														<td>
															<button class="btn btn-xs btn-warning" title="错误日志"
																onclick="doShowLog('${result.guideNo}','${result.cardNo}')">
																<i class="icon-list"></i>
															</button>
															<button class="btn btn-xs btn-primary" title="重新爬取"
																onclick="doRecycle(this,'${result.guideNo}','${result.cardNo}')">
...
<script type="text/javascript">
	function doRecycle(obj, guideNo, cardNo) {
		$.ajax({
			cache : true,
			type : 'POST',
			url : '${ctx}/touristGuide/doRecycle',
			data : {
				guideNo : guideNo,
				cardNo : cardNo
			},
	...
	function doShowDetail(guideNo, cardNo) {
		$.ajax({
			cache : true,
			type : 'GET',
			url : '${ctx}/touristGuide/queryInfo',
			data : {
				guideNo : guideNo,
				cardNo : cardNo
			},
	...
	function doShowLog(guideNo, cardNo) {
		$.ajax({
			cache : true,
			type : 'GET',
			url : '${ctx}/touristGuide/queryLog',
			data : {
				guideNo : guideNo,
				cardNo : cardNo
			},
