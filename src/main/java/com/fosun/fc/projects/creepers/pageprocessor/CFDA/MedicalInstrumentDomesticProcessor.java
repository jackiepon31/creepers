...
public class MedicalInstrumentDomesticProcessor implements PageProcessor {
    ...
    private static final String URL_PAGE_TEMPLATE = "http://qy1.sfda.gov.cn/datasearch/face3/search.jsp?tableId=26&bcId=118103058617027083838706701567&curstart=";

    private static final String REGEX_URL_PAGE = "http://qy1.sfda.gov.cn/datasearch/face3/search.jsp\\?tableId=26&bcId=118103058617027083838706701567&curstart=";

    private static final String REGEX_URL_DETAIL = "http://qy1.sfda.gov.cn/datasearch/face3/content.jsp\\?tableId=26&tableName=TABLE26&tableView=国产器械&Id=";
    ...
    public MedicalInstrumentDomesticProcessor() {
        if (null == site) {
            site = Site.me().setDomain("qy1.sfda.gov.cn").setUserAgent(
                    ...
                    .setSleepTime(3100).setTimeOut(90000);
        }
...
//        logger.info("page.Html:" + page.getHtml().toString());
        ...
        if (page.getUrl().toString().equals(param.getOrderUrl(BaseConstant.OrderUrlKey.INDEX_URL))) {
            ...
            for (Selectable td : tdList) {
                ...
                String detailURL = "http://qy1.sfda.gov.cn/datasearch/face3/content.jsp?tableId=26&tableName=TABLE26&tableView=国产器械&Id="
                        + td.regex(";Id=(.*)',null");
    ...
    public static void main(String[] args) {
        ...
        Spider.create(new MedicalInstrumentDomesticProcessor()).setDownloader(new HttpRequestDownloader().setParam(param))
